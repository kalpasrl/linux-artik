 ...
 * <https://github.com/STFlightSenseLinuxDrivers/vl53l0-driver/blob/master/drivers/input/misc/vl53L0/stmvl53l0_module.c>
 *
 */
...
int stmvl53l0x_poll_thread(void *data)
{
	...
	while(!kthread_should_stop()) {
		...
		ret = wait_event_timeout(vl53l0x_dev->poll_thread_wq,
			(vl53l0x_dev->enable_ps_sensor || poll_thread_exit), msecs_to_jiffies(5000));
