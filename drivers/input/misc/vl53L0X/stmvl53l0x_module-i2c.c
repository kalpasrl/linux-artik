 ...
 *
 *  Author: Sergio Quarta		<info@kalpa.it>
 *  Author: Fulvio Carlassara	<info@kalpa.it>
 *
 ...
 * <https://github.com/STFlightSenseLinuxDrivers/vl53l0-driver/blob/master/drivers/input/misc/vl53L0/stmvl53l0_module-i2c.c>
 *
 */
...
MODULE_DEVICE_TABLE(of, st_stmvl53l0x_dt_match);
				   ...
				   const struct i2c_device_id *id)
{
	...
	vl53l0x_dbgmsg("Enter\n");
        ...
        match = of_match_device(of_match_ptr(st_stmvl53l0x_dt_match),
					&client->dev);
	if (match) {
            vl53l0x_dbgmsg("CLIENT I2C MATCH\n");


        }
        else
        {
            vl53l0x_dbgmsg("CLIENT I2C NO MATCH\n");
            return -1 ;
        }
        vl53l0x_dbgmsg("CLIENT I2C ADDR : %d - \n" , client->addr);
...
static struct i2c_driver stmvl53l0x_driver = {
	.driver = {
		...
		.owner	= THIS_MODULE,
		.of_match_table = of_match_ptr(st_stmvl53l0x_dt_match) ,
	},
...
int stmvl53l0x_init_i2c(void)
{
	...
	struct i2c_board_info info = {
        ...
        vl53l0x_dbgmsg("STM_TEST DEFINED\n");
